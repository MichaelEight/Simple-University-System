    ...
    <main>
      <div>
        <div className='main-center-text border-box'>
          ...
          <p style={{ fontWeight: 'bold', fontSize: '32px', marginTop:'10px', marginBottom:'54px' }}>WITAJ W SYSTEMIE SUS</p>
        </div>
        
        <div className="main-spacer"></div>

        <p style={{ fontWeight: 'bold', fontSize: '24px', marginTop:'10px', marginBottom:'10px', borderBottom: '2px solid #999' }}>UWAGA TECHNICZNA</p>
