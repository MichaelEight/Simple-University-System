    ...
    useEffect(() => {
      const loadUserData = async () => {
        try {
          ...
          const cachedData = localStorage.getItem('userProfileTeacherData');
          const cachedTimestamp = localStorage.getItem('userProfileTeacherDataTimestamp');
            ...
            if (response.ok) {
              ...
              if (data.valid) {
                ...
                if (dataResponse.ok) {
                  ...
                  localStorage.setItem('userProfileTeacherData', JSON.stringify(userDataFromDB));
                  localStorage.setItem('userProfileTeacherDataTimestamp', currentTimestamp.toString());
                } else {
